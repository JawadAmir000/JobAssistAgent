...
class ApplyContext:
    ...
    seen: Callable[..., None] = lambda *_a, **_k: None      # seen(value, label="")
...
# The modules an adapter fix can live in, in dependency order: common and resolver first, because the
# adapters bind them by name at import and would otherwise keep pointing at the old copies.
_RELOADABLE = ("jobbot.apply.common", "jobbot.apply.resolver", "jobbot.apply.generic",
...
_HOSTS: tuple[tuple[str, str], ...] = (
    ...
    ("icims.com", "icims"),                     # Atlassian and much of the enterprise mid-market
